...
//   RCP<const Tpetra::Map<> > map = A->getDomainMap();
   ...
   std::string Label1 ="QR factor time MvDot operations in CGS2";
   std::string Label2 ="QR factor time MvTransMv operations in CGS2";
   std::string Label3 ="QR factor time MvTimesMatAddMv operations in CGS2";
