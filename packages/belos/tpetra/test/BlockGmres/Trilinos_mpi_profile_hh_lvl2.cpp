...
//   RCP<const Tpetra::Map<> > map = A->getDomainMap();
   ...
   std::string Label1 ="QR factor time MvDot operations in HH level 2";
   std::string Label2 ="QR factor time MvTransMv operations in HH level 2";
   std::string Label3 ="QR factor time MvTimesMatAddMv operations in HH level 2";
   std::string Label4 ="QR factor time TRMV operations in HH level 2";
   std::string Label5 ="QR factor time GetLocalViewHost operations in HH level 2";
   std::string Label6 ="QR factor time Broadcasting operations in HH level 2";
