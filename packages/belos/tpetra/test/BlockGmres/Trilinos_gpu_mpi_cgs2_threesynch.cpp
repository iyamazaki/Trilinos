...
//  ViewVectorType work1( "work1", n );
  typedef Kokkos::View<double**>  ViewMatrixType;
  ViewMatrixType RR( "RR", n, n );
   ...
   if( Testing ){  
      ...
      for(i=0;i<n;i++){ for(j=0;j<i+1;j++){ (*R)(j,i) = RR(j,i); }}
