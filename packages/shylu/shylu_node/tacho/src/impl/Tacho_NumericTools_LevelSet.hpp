...
public:
  ...
  inline void factorize(const value_type_array &ax, const bool store_transpose, const mag_type pivot_tol = 0.0, const bool pivot = true, const ordinal_type verbose = 0) override {
